...
public extension UIRefreshControl {
    ...
    public func beginRefreshing(in collectionView: UITableView, animated: Bool, sendAction: Bool = false) {
        ...
        assert(superview == collectionView, "Refresh control does not belong to the receiving table view")
